...
**标签:**  [设计](https://leetcode-cn.com/tag/design) [数组](https://leetcode-cn.com/tag/array) [哈希表](https://leetcode-cn.com/tag/hash-table) [矩阵](https://leetcode-cn.com/tag/matrix) 