...
**标签:**  [树](https://leetcode.cn/tag/tree) [二叉搜索树](https://leetcode.cn/tag/binary-search-tree) [链表](https://leetcode.cn/tag/linked-list) [分治](https://leetcode.cn/tag/divide-and-conquer) [二叉树](https://leetcode.cn/tag/binary-tree) 